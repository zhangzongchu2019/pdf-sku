...
> **版本**: V1.4
> **日期**: 2026-02-21
> **对齐文档**: BRD V2.1 · BA V1.1 · TA V1.7
> **适用范围**: 前端工程团队、交互设计、QA  
> **V1.4 变更**: 新增 /config/import 商品导入配置页面；Job 详情页增强（Pages 缩略图列、展开行、SKU 图片预览、属性展开、Lightbox）；修订 §1.1 路由表、§1.2 权限矩阵
...
│   ├── /config/import                → 商品导入配置（API+字段映射+COS）[V1.4 新增]
